                    ...
                    <div class="col-xl-6">
                        <div class="about-four__right">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">About Online Charity</span>
                                <h2 class="section-title__title">Get to know about our
                                    Online Charity organization</h2>
                            </div>
        ...
        <section class="testimonial-two">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">What they’re talking <br> about Online Charity</h2>
                </div>
