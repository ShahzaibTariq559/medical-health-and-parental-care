...
<?php    
	 $headTitle="Home Three | Online Charity Plateform";
        ...
        <header class="main-header-four">
            <nav class="main-menu main-header-four__inner">
                <div class="main-header-four__logo">
                   <a href="/"><img src="{{ asset('assets/images/resources/logo-3.png') }}" width="135" alt="oxpins"></a>
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="about-five__content">
                                <div class="section-title">
                                    ...
                                    <h2 class="section-title__title">We’re Non-Profit oxpins & Muslim Organization</h2>
                                </div>
                        ...
                        <div class="col-lg-8">
                            <ul class="list-unstyled counter-two__list">
                                <li class="counter-two__single">
                                    <div class="counter-two__icon"><i class="oxpins-icon-two-oxpins"></i></div>
                        ...
                        <div class="news-three__single">
                            <div class="news-three__single__img">
                                ...
                                <div class="news-three__single__cats">
                                    <a href="{{ route('newsDetails') }}">oxpins</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__about-logo">
                                   <a href="/"><img src="{{ asset('assets/images/resources/footer-logo-two.png') }}" alt="oxpins"></a>
                                </div>
