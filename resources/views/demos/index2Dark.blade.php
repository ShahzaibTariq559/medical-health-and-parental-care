...
@php
    $headTitle='Home Two | Online Charity Plateform';
                    ...
                    <div class="main-menu-two__wrapper-inner">
                        <div class="main-menu-two__left">
                            <div class="main-menu-two__logo">
                               <a href="/"><img src="{{ asset('assets/images/resources/logo-2.png') }}" alt=""></a>
                            </div>
                        ...
                        <div class="about-two__right">
                            ...
                            <div class="about-two__progress">
                                <div class="about-two__progress-single">
                                    <h4 class="about-two__progress-title">oxpins</h4>
                                    <div class="bar">
                                ...
                                <div class="causes-two__tab-btn-box">
                                    <ul class="tab-buttons clearfix list-unstyled">
                                        ...
                                        <li data-tab="#food-water" class="tab-btn"><span>Food & water
                                                <sup>2</sup></span></li>
                                        <li data-tab="#oxpins" class="tab-btn"><span>oxpins for poors
                                                <sup>3</sup></span></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <ul class="list-unstyled contact-one__list">
                        <li class="contact-one__single">
                            ...
                            <div class="contact-one__content">
                                ...
                                <h3 class="contact-one__number"><a href="tel:+923056266559">+92 (305) 626 6559</a></h3>
                            </div>
                        </li>
                        <li class="contact-one__single">
                            <div class="contact-one__icon">
                            ...
                            <div class="contact-one__content">
                                ...
                                <h3 class="contact-one__number"><a href="mailto:shahzaibtariq559@gmail.com">shahzaibtariq559@gmail.com</a></h3>
                            </div>
                        </li>
                        <li class="contact-one__single">
                            <div class="contact-one__icon">
