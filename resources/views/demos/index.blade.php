                                    ...
                                    <div class="main-menu__right-top-address">
                                        <ul class="list-unstyled main-menu__right-top-address-list">
                                            <li>
                                                ...
                                                <div class="content">
                                                    <p>Helpline</p>
                                                    <h5><a href="tel:+923056266559">+92 (305) 626 6559</a></h5>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="icon">
                                                ...
                                                <div class="content">
                                                    <p>Send email</p>
                                                    <h5><a href="mailto:shahzaibtariq559@gmail.com">shahzaibtariq559@gmail.com</a>
                                                    </h5>
                                                </div>
                                            </li>
                                            <li>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image:url('{{ asset('assets/images/backgrounds/main-slider-1-1.png') }}')"></div>
                        <!-- /.image-layer -->

                        <div class="main-slider-shape-1" style="background-image:url('{{ asset('assets/images/shapes/main-slider-shape-1.jpg') }}')"></div>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image:url('{{ asset('assets/images/backgrounds/main-slider-1-2.png') }}')"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image:url('{{ asset('assets/images/backgrounds/main-slider-1-3.png') }}')"></div>
                        <!-- /.image-layer -->
                                ...
                                <div class="about-one__curved-circle-box">
                                    <div class="curved-circle">
                                        <span class="curved-circle--item">
                                            25 YEARS EXPERIENCE oxpins oxpins CENTER
                                        </span>
                                    </div><!-- /.curved-circle -->
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">Welcome to oxpins oxpins</span>
                        ...
                        <li class="gallery-one__single wow fadeInUp" data-wow-delay="100ms">
                            <div class="gallery-one__img">
                                ...
                                <div class="gallery-one__content">
                                    <!-- /.img-popup -->
                                    <p class="gallery-one__sub-title">oxpins</p>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="faq-one__left">
                            ...
                            <p class="faq-one__text-1">Proactively procrastinate cross-Plateform results via extensive
